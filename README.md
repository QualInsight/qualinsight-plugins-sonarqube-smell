...
_Note 2:_ Unfortunately SonarSource [refused to add the plugin to SonarQube's update center](https://groups.google.com/d/msg/sonarqube/d8vQyKxqPZk/fa2csHAVDwAJ) due to the fact that they consider the name of the plugin as being inappropriate.
